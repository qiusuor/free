...
def get_feature_cols():
    ...
    for file in os.listdir(DAILY_DIR):
        ...
        df = joblib.load(path)
        no_feature_cols = set(["code", "adjustflag", "tradestatus", "code_name", "shiborON", "shibor1W", "shibor2W", "shibor3M", "shibor9M", "shibor1Y", "industry"] + [col for col in df.columns if col.startswith("y") or col.startswith("dy") or col.startswith("emb")])
