...
def get_feature_cols():
    ...
    no_feature_cols = set(["open", "high", "low", "close", "preclose", "industry", "amount", "code", "adjustflag", "tradestatus", "code_name", 'isST'] + [col for col in df.columns if col.startswith("y") or col.startswith("dy")])
