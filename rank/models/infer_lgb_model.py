...
def train_lightgbm(argv):
    features, label, train_start_day, train_end_day, val_start_day, val_end_day, n_day, train_len, num_leaves, max_depth, min_data_in_leaf, cache_data, epoch, gbm = argv
    params = {
        'task': 'train',
        'boosting_type': 'gbdt',
        'objective': 'binary',
    ...
    save_dir = "{}/side/{}/{}/{}".format(root_dir, label, param_des, to_int_date(val_start_day))
...
if __name__ == "__main__":
    ...
    gbm = joblib.load("/home/qiusuo/free/rank/exp_cls_pred/y_next_2_d_ret_12/250_3_3_11/20231019/model.pkl")
                ...
                for max_depth in [3, 7, 9, 12]:
                    ...
                    # for train_len in [30, 50, 120, 180]:
                        ...
                        for train_val_split_day in trade_days[-val_n_day-2*n_day-val_delay_day:-2*n_day-val_delay_day]:
                            ...
                            argv = [
                                features, label, train_start_day, train_end_day, to_date(20231011),
                                to_date(20240207), n_day, train_len, num_leaves, max_depth, min_data_in_leaf, cache_data, 100, gbm
                            ]
    ...
    pool.close()
    pool.join()
    agg_prediction_info(ana_dir="/home/qiusuo/free/rank/exp_cls_pred/side", last_n_day=val_n_day)
