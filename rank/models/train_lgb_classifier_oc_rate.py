            ...
            for min_data_in_leaf in [11, 21, 41, 81]:
                for max_depth in [3, 7, 9, 12]:
                    ...
                    # for train_len in [30, 50, 120, 180]:
                        ...
                        print(len(argvs))
                        # print(trade_days[-val_n_day-2*n_day-val_delay_day:-2*n_day-val_delay_day], trade_days[-val_n_day-2*n_day:-2*n_day])
                        
                        for train_val_split_day in trade_days[-val_n_day-2*n_day-val_delay_day-1:-2*n_day-val_delay_day-1]:
